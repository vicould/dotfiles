...
syn match pythonPreCondit "^import\s" display nextgroup=pythonDottedName skipwhite
syn match pythonPreCondit "\simport\s" display nextgroup=pythonDottedName skipwhite
syn match pythonPreCondit "\sas\s" display nextgroup=pythonDottedName skipwhite
syn match pythonPreCondit "^from\s" display nextgroup=pythonDottedName skipwhite
...
if exists("python_highlight_builtin_objs") && python_highlight_builtin_objs != 0
  ...
  syn keyword pythonBuiltinObj	self args kwargs
endif
